...
/**
 * NonRentalUnitsFixture
 *
 */
class NonRentalUnitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'min_deposit' => ['type' => 'decimal', 'length' => 20, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'amount' => 1.5,
                'min_deposit' => 1.5,
                'created' => '2018-06-26 14:54:51',
                'modified' => '2018-06-26 14:54:51'
            ],
        ];
        parent::init();
    }
