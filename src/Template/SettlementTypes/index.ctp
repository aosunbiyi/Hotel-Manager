 ...
 * @var \App\Model\Entity\SettlementType[]|\Cake\Collection\CollectionInterface $settlementTypes
 */
?>
 ...
 <div class="m-subheader ">
   ...
   <div class="m-portlet m-portlet--mobile">
        ...
        <tbody>
            <?php foreach ($settlementTypes as $settlementType): ?>
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $settlementType->id],['class'=>'btn btn-danger btn-sm'], ['confirm' => __('Are you sure you want to delete # {0}?', $settlementType->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
