...
<div class="m-portlet m-portlet--tab">
                                ...
                                <?= $this->Form->create($settlementType,['class'=>'m-form m-form--fit m-form--label-align-right']) ?>
...
echo $this->Form->control('payment_option',['class'=>'form-control m-input m-input--square']);
