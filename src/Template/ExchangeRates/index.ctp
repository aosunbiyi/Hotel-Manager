 ...
 * @var \App\Model\Entity\ExchangeRate[]|\Cake\Collection\CollectionInterface $exchangeRates
 */
?>
   ...
   <div class="m-portlet m-portlet--mobile">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $exchangeRate->id],['class'=>'btn btn-primary btn-sm']) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $exchangeRate->id],['class'=>'btn btn-success btn-sm']) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $exchangeRate->id],['class'=>'btn btn-danger btn-sm'], ['confirm' => __('Are you sure you want to delete # {0}?', $exchangeRate->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
